        ...
        for panel_name, panel_cables in panel_wise_data.items():
            ...
            for motor_number_index, (motor_name, motor_cables) in enumerate(
                ...
                for cable_index, cable in enumerate(motor_cables, start=1):
                    ...
                    cable_schedule_sheet.cell(current_row, 2).style = (
                        "center_border_style"
                    )
                    cable_schedule_sheet.merge_cells(
                        start_row=current_row,
                    ...
                    cable_schedule_sheet.cell(current_row, 3).style = (
                        "center_border_style"
                    )
                    cable_schedule_sheet.merge_cells(
                        start_row=current_row,
                    ...
                    # 11th column K: TYPE
                    cable_schedule_sheet.cell(current_row, 11).style = (
                        "center_border_style"
                    )
                    cable_schedule_sheet.merge_cells(
                        start_row=current_row,
                    ...
                    cable_schedule_sheet.cell(current_row, 12).style = (
                        "center_border_style"
                    )
                    cable_schedule_sheet.merge_cells(
                        start_row=current_row,
                    ...
                    cable_schedule_sheet.cell(current_row, 13).style = (
                        "center_border_style"
                    )
                    cable_schedule_sheet.merge_cells(
                        start_row=current_row,
                    ...
                    cable_schedule_sheet.cell(current_row, 13).value = (
                        extract_cable_type(cable.get("type_of_cable"))
                    )

                    # 16th column P: TAG NOS.
                    cable_schedule_sheet.cell(current_row, 16).style = (
                        "center_border_style"
                    )
                    cable_schedule_sheet.merge_cells(
                        start_row=current_row,
                    ...
                    cable_schedule_sheet.cell(current_row, 18).style = (
                        "center_border_style"
                    )
                    cable_schedule_sheet.merge_cells(
                        start_row=current_row,
                    ...
                    cable_schedule_sheet.cell(current_row, 19).style = (
                        "center_border_style"
                    )
                    cable_schedule_sheet.merge_cells(
                        start_row=current_row,
                    ...
                    cable_schedule_sheet.cell(current_row, 20).style = (
                        "center_border_style"
                    )
                    cable_schedule_sheet.merge_cells(
                        start_row=current_row,
                    ...
                    cable_schedule_sheet.cell(current_row, 20).value = cable.get(
                        "cable_od"
                    )

                    # 21st column U: ENTRY AVAILABLE AT PANEL / JB
                    cable_schedule_sheet.cell(current_row, 21).style = (
                        "center_border_style"
                    )
                    cable_schedule_sheet.merge_cells(
                        start_row=current_row,
                    ...
                    cable_schedule_sheet.cell(current_row, 22).style = (
                        "center_border_style"
                    )
                    cable_schedule_sheet.merge_cells(
                        start_row=current_row,
                    ...
                    size_selection_dropdowns.add(
                        cable_schedule_sheet[f"V{current_row}"]
                    )

                    # 23rd column W: GLAND CAT NO AT PANEL / JB
                    cable_schedule_sheet.cell(current_row, 23).style = (
                        "center_border_style"
                    )
                    cable_schedule_sheet.merge_cells(
                        start_row=current_row,
                    ...
                    cable_schedule_sheet.cell(current_row, 24).style = (
                        "center_border_style"
                    )
                    cable_schedule_sheet.merge_cells(
                        start_row=current_row,
                    ...
                    cable_schedule_sheet.cell(current_row, 25).style = (
                        "center_border_style"
                    )
                    cable_schedule_sheet.merge_cells(
                        start_row=current_row,
                    ...
                    cable_schedule_sheet.cell(current_row, 26).style = (
                        "center_border_style"
                    )
                    cable_schedule_sheet.merge_cells(
                        start_row=current_row,
                    ...
                    cable_schedule_sheet.cell(current_row, 27).style = (
                        "center_border_style"
                    )
                    cable_schedule_sheet.merge_cells(
                        start_row=current_row,
                    ...
                    size_selection_dropdowns.add(
                        cable_schedule_sheet[f"AA{current_row}"]
                    )

                    # 28th column AB: GLAND CAT NO AT EQUIPMENT
                    cable_schedule_sheet.cell(current_row, 28).style = (
                        "center_border_style"
                    )
                    cable_schedule_sheet.merge_cells(
                        start_row=current_row,
                    ...
                    cable_schedule_sheet.cell(current_row, 29).style = (
                        "center_border_style"
                    )
                    cable_schedule_sheet.merge_cells(
                        start_row=current_row,
                    ...
                    cable_schedule_sheet.cell(current_row, 30).style = (
                        "center_border_style"
                    )
                    cable_schedule_sheet.merge_cells(
                        start_row=current_row,
                    ...
                    cable_schedule_sheet.cell(current_row, 31).style = (
                        "center_border_style"
                    )
                    cable_schedule_sheet.merge_cells(
                        start_row=current_row,
                    ...
                    for row in range(number_of_cores):
                        ...
                        cable_schedule_sheet.row_dimensions[
                            current_row + row
                        ].height = 40
                        ...
                        cable_schedule_sheet.cell(current_row + row, 32).value = (
                            cable.get("comment")
                        )
