...
def get_heating_db_excel(
    ...
    for project_panel in project_panel_data:
        ...
        if project_panel.get("panel_main_type") == "MCC":
            ...
            panel_sheet["C6"] = mcc_panel_data.get("panel_incomer_protection")
            ...
            panel_sheet["C17"] = handle_none_to_string(mi_communication_protocol)
            ...
            panel_sheet["C59"] = boiler_model
            panel_sheet["C60"] = boiler_fuel
            panel_sheet["C61"] = boiler_year
            panel_sheet["C62"] = mcc_boiler_power_supply
            panel_sheet["C63"] = mcc_boiler_control_supply
            panel_sheet["C64"] = boiler_evaporation
            panel_sheet["C65"] = boiler_output
            panel_sheet["C66"] = boiler_connected_load
            panel_sheet["C67"] = boiler_design_pressure
            ...
            panel_sheet["C69"] = heater_model
            panel_sheet["C70"] = heater_fuel
            panel_sheet["C71"] = heater_year
            panel_sheet["C72"] = mcc_heater_power_supply
            panel_sheet["C73"] = mcc_heater_control_supply
            panel_sheet["C74"] = heater_evaporation
            panel_sheet["C75"] = heater_output
            panel_sheet["C76"] = heater_connected_load
            panel_sheet["C77"] = heater_temperature
            ...
            panel_sheet["C57"] = boiler_model
            panel_sheet["C58"] = boiler_fuel
            panel_sheet["C59"] = boiler_year
            panel_sheet["C60"] = pcc_boiler_power_supply
            panel_sheet["C61"] = pcc_boiler_control_supply
            panel_sheet["C62"] = boiler_evaporation
            panel_sheet["C63"] = boiler_output
            panel_sheet["C64"] = boiler_connected_load
            panel_sheet["C65"] = boiler_design_pressure
            ...
            panel_sheet["C67"] = heater_model
            panel_sheet["C68"] = heater_fuel
            panel_sheet["C69"] = heater_year
            panel_sheet["C70"] = pcc_heater_power_supply
            panel_sheet["C71"] = pcc_heater_control_supply
            panel_sheet["C72"] = heater_evaporation
            panel_sheet["C73"] = heater_output
            panel_sheet["C74"] = heater_connected_load
            panel_sheet["C75"] = heater_temperature
